...
- /InfoBot/doc - директория с файлами для кнопок 'файлы'.
- /InfoBot/photo - директория с картинками для кнопок 'фотки'.
- /InfoBot/video - директория с картинками для кнопок 'видео'.
- /InfoBot/audio - директория с картинками для кнопок 'аудио'.
- /InfoBot/json/History.json - json-файл c личными историями для раздела 'Личные истории'.
- /InfoBot/json/Tree.json - json-файл сo структурой кнопок бота.
